<header class="mb-6 flex justify-between items-center border-b border-gray-200 pb-4">
    ...
    <div class="flex items-center space-x-4">
        ...
        <button 
            ...
            class="text-gray-800" {{-- <-- Ubah warna ke 'text-gray-800' agar terlihat --}}
            title="Buka Sidebar"
        >
        ...
        <img id="img-logo-random-shot" 
             src="{{ asset('img/logo-rs.png') }}"
             alt="logo_random_shot"
             class="w-48 h-auto">
    </div>
    ...
    <div x-data="{ open: false }" class="relative">
        <button @click="open = !open" class="flex items-center focus:outline-none" title="Pengaturan Akun">
            ...
            <div class="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center text-white font-semibold border-2 border-gray-700">
                A
            </div>
        </button>
