<x-Layout>
    ...
    <section x-data="{ pilihMeja: false }" class="min-h-screen bg-[#0e0f0b] text-white px-8 pt-20 pb-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
            ...
            <div class="lg:col-span-2 space-y-3">
                ...
                <div class="border border-white/20 rounded-xl p-4 flex gap-4">
                    ...
                    <img src="{{ asset('img/meja1.png') }}" class="w-36 h-32 object-cover rounded-md">
                ...
                <div class="border border-white/20 rounded-xl p-4 flex gap-4">
                    ...
                    {{-- FOTO MAKANAN --}}
                    <img src="{{ asset('img/menu/indomie.png') }}" class="w-36 h-28 object-cover rounded-md">
        ...
        {{-- POPUP PILIH MEJA --}}
        <div x-show="pilihMeja" x-transition.opacity @click.self="pilihMeja = false"
            class="fixed inset-0 bg-black/60 backdrop-blur z-50 flex items-center justify-center">

            <div x-show="pilihMeja" x-transition.duration.300ms class="bg-[#151515] w-full max-w-xl p-6 rounded-t-2xl">
                ...
                <button @click="pilihMeja = false" class="mt-5 w-full py-3 bg-red-600 font-bold rounded-xl">
                    Konfirmasi
                </button>
