<x-Layout>
    ...
    <section class="min-h-screen bg-black text-[#F4EFE7] flex">
        ...
        <aside class="w-72 bg-[#2e2e2c] py-24 px-8 flex flex-col">
            ...
            <a href="{{ route('customer.profile') }}" class="w-full py-3 rounded-xl bg-transparent mb-3 text-center">
                Informasi Akun
            </a>
        ...
        <main class="flex-1 py-24">
            ...
            <div class="space-y-5">
                ...
                {{-- CARD 1 --}}
                <div
                    class="ml-6 mr-6 flex bg-[#141414] rounded-xl border border-[#F4EFE7] 
                        overflow-hidden relative">

                    <img src="{{ asset('img/menu/indomie.png') }}" class="w-40 h-28 object-cover">
