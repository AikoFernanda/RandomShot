            ...
            <div class="flex flex-wrap">
                <div class="w-full self-center py-20 px-10">
                    ...
                    <div class="mt-8 flex justify-center mb-48">
                        <a href="#reservasi" 
                           class="border border-white bg-gray-100/70 text-black hover:text-[#F4EFE7] px-5 py-2 rounded-md text-base font-medium hover:bg-black/75 transition shadow-lg">
                           Lihat Layanan >
                        </a>
                    </div>
                </div>
