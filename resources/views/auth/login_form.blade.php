<x-Layout>
    ...
    <div style="background-image: url('{{ asset('img/login.png') }}');"
        ...
        <div class="w-1/3 bg-[#101B08] border border-[#F4EFE7] p-8 rounded-lg shadow-lg transform -translate-x-10">
            ...
            <!-- Form Login -->
            <form action="{{ route('login.validation') }}" method="POST" class="space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" placeholder="you@gmail.com" required
                        class="w-full bg-[#F4EFE7]/30 text-[#F4EFE7] border border-[#F4EFE7] rounded-md p-3 focus:ring-green-500 focus:border-green-500">
                </div>
        ...
        <!-- logo -->
        <img src="{{ asset('img/logo-rs.png') }}" class="w-125 translate-x-10">
