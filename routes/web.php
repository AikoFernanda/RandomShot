...
Route::post('/test_register_customer', [AuthenticationController::class, 'customerRegister']);

Route::post('/test_login_customer', [AuthenticationController::class, 'customerLogin']);